...
import 'package:tanqiy/widgets/xp_gain_toast.dart';
...
class _KuisPageState extends State<KuisPage> {
  ...
  void initState() {
    ...
    // ── XP popup ─────────────────────────────────────
    ever(controller.xpPopupTrigger, (_) {
      if (controller.xpPopupValue > 0) {
        WidgetsBinding.instance.addPostFrameCallback((_) {
          if (mounted) {
            XpGainToast.show(controller.xpPopupValue);
          }
        });
      }
    });
